echo "This is the openauto for Android on Rasperry Pi 3. This will take some time depnding on your connectiong speed."
sleep 15
...
echo "Now you can run openauto at /home/pi/openauto/bin/autoapp and you should be up and running."